...
var Comments = /** @class */ (function (_super) {
    ...
    Comments.prototype.render = function () {
        var _this = this;
        var _a = this.props, dataSource = _a.dataSource, reference = _a.reference, referenceID = _a.referenceID;
        return (React.createElement(ResourceCollectionLayer, { name: "comments", key: "job_comments_" + reference + "_" + referenceID, fields: [
                "id",
                "text",
                "createdBy",
                "createdByUser { family_name given_name }",
                "createdAt",
            ], initialFilters: { reference: reference, referenceID: referenceID }, initialSorting: [
    ...
    Comments.prototype.commentsForm = function (comments) {
        var _a = this.props, dataSource = _a.dataSource, reference = _a.reference, referenceID = _a.referenceID, textareaProps = _a.textareaProps;
        return (React.createElement(ResourceLayer, { name: "Comment", dataSource: dataSource, fields: ["text"], initialValues: { reference: reference, referenceID: referenceID }, render: function (resource) { return (React.createElement(CommentsForm, { resource: resource, onMessageSent: function () { return comments.reload(); }, textareaProps: textareaProps })); } }));
    };
    return Comments;
}(React.Component));
export { Comments };
