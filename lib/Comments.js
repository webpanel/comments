...
import { SortInfoOrder, useResource, useResourceCollection, } from "webpanel-data";
import { CommentsForm } from "./CommentsForm";
import { CommentsList } from "./CommentsList";
import { ResourceCard } from "webpanel-antd";
var CommentsFormInstance = function (props) {
    var dataSource = props.dataSource, reference = props.reference, referenceID = props.referenceID, textareaProps = props.textareaProps, comments = props.comments;
    ...
    return (React.createElement(CommentsForm, { resource: resource, onMessageSent: function () { return comments.reload(); }, textareaProps: textareaProps }));
};
export var Comments = function (props) {
    var dataSource = props.dataSource, reference = props.reference, referenceID = props.referenceID;
    var comments = useResourceCollection({
        name: "comments",
        fields: [
            "id",
            "text",
    ...
    return (React.createElement(ResourceCard, { observedResource: comments, title: "Koment\u00E1\u0159e" },
        ...
        React.createElement("div", { style: {
            ...
            React.createElement(CommentsList, { items: comments.data || undefined, loadMore: function () { return comments.updateLimit((comments.limit || 0) + 10); }, hasMore: !comments.loading &&
                    ...
                    comments.count > comments.limit, onDelete: function (item) { return __awaiter(void 0, void 0, void 0, function () {
