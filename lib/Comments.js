...
var Comments = /** @class */ (function (_super) {
    ...
    Comments.prototype.commentsForm = function (comments) {
        var _a = this.props, dataSource = _a.dataSource, reference = _a.reference, referenceID = _a.referenceID;
        return (React.createElement(ResourceLayer, { name: "Comment", dataSource: dataSource, fields: ["text"], initialValues: { reference: reference, referenceID: referenceID }, render: function (resource) { return (React.createElement(CommentsForm, { resource: resource, onMessageSent: function () { return comments.reload(); } })); } }));
    };
    return Comments;
}(React.Component));
export { Comments };
