...
var CommentsList = /** @class */ (function (_super) {
    ...
    CommentsList.prototype.render = function () {
        ...
        return (React.createElement(ResourceCollectionLayer, { name: "comments", key: "job_comments_" + this.props.referenceID, fields: [
            ...
            ], initialLimit: 10, initialOffset: 0, dataSource: api, render: function (comments) { return (React.createElement(ResourceCard, { observedResource: comments, title: "Koment\u00E1\u0159e" },
                _this.props.inputPosition === 'top' && (React.createElement("div", { style: { marginBottom: '10px' } },
                    React.createElement(CommentsForm, { referenceID: _this.props.referenceID, onMessageSent: function () { return comments.reload(); } }))),
                React.createElement("div", { style: {
                        overflow: 'scroll',
                        maxHeight: '512px'
                    } },
                    React.createElement(InfiniteScroll, { threshold: 64, loadMore: function () {
                            return comments.updateLimit((comments.limit || 0) + 10);
                        }, useWindow: false, hasMore: !comments.loading &&
                            comments.limit !== undefined &&
                            comments.count !== undefined &&
                            comments.count > comments.limit },
                        React.createElement(List, { size: "small", itemLayout: "horizontal", dataSource: comments.data || undefined, renderItem: function (item) { return (React.createElement(List.Item, null,
                                React.createElement(List.Item.Meta, { title: React.createElement("div", null,
                                        ...
                                        hasAccess('deleteComment') && (React.createElement(DeleteButton, { onDelete: function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                (_this.props.inputPosition === undefined ||
                    _this.props.inputPosition === 'bottom') && (React.createElement(CommentsForm, { referenceID: _this.props.referenceID, onMessageSent: function () { return comments.reload(); } })))); } }));
    };
    return CommentsList;
}(React.Component));
export { CommentsList };
//# sourceMappingURL=CommentsListResource.js.map