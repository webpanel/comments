...
export var Comments = function (props) {
    ...
    var dataSource = props.dataSource, reference = props.reference, referenceID = props.referenceID, canDelete = props.canDelete;
    ...
    return (React.createElement(ResourceCard, { observedResource: comments, title: t("comments_card_title") },
