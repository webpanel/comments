...
var CommentsForm = /** @class */ (function (_super) {
    ...
    CommentsForm.prototype.render = function () {
        ...
        return (React.createElement(ResourceForm, { onSuccess: this.onSuccess, formResource: resource, render: function (context) { return (React.createElement(AInput.Group, { className: "display-flex" },
